		                            ...
		                            <li class="ticket-item">
		                                <div class="row">
		                                    ...
		                                    <div class="ticket-time  col-md-4 col-sm-6 col-xs-12">
		                                        ...
		                                        <span class="time">{{ \Carbon\Carbon::parse($reservation->created_at)->diffForHumans() }}</span>
		                                    </div>
		                                    ...
		                                    <div class="ticket-state  bg-palegreen col-md-4 col-sm-6 col-xs-12">
												<form action="route('conferme.reservation')" method="POST">
													@csrf
											        @method('PUT')
													<input type="hidden" name="id_reservation" value="{{$reservation->id}}">
													<button type="submit" style="color: #80af4e" class="btn  btn-circle">
